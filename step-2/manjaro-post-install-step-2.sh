...
echo -n "."
sudo pacman -R geary &>> $logfile
echo -n "."
sudo pacman -R kazam &>> $logfile
echo -n "."
sudo pacman -R onlyoffice-desktopeditors &>> $logfile
